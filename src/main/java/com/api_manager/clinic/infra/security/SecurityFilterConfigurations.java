package com.api_manager.clinic.infra.security;
...
public class SecurityFilterConfigurations {
    ...
    @Autowired
    SecurityFilterToken securityFilterToken;
        ...
        return httpSecurity.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers(HttpMethod.POST, "/client").hasRole(UserRole.ADMIN.name())
